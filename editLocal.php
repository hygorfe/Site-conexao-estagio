...
if(isset($_GET["id"])){
   ...
   $sql = "SELECT ID_localidade, cep, endereco, numero, complemento, bairro, cidade, estado FROM localidade WHERE ID_localidade = '$ID_localidade'";
...
<section class="modal-container">
    ...
    <form class="forms" action="editLocalSave.php" method="POST">
    <input type="hidden" name="id" value="<?php echo $ID_localidade;?>">
    <div class="box">
    ...
    <div class="btn-modal">
    <a href="localidade.php" class="cancelar">Cancelar</a>
