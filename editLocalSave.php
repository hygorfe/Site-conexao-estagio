...
if(isset($_POST["submitAtualizar"])){
  ...
  $sql = "UPDATE localidade SET cep = '$CEP', endereco = '$endereco', numero = '$numero', complemento ='$complemento', bairro = '$bairro', cidade = '$cidade', estado = '$estado' WHERE ID_localidade = '$ID_localidade'";
